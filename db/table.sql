...
CREATE TABLE Model (ModelID INT AUTO_INCREMENT PRIMARY KEY, ModelName VARCHAR(50), image LONGBLOB, ModelDescription TEXT, CategoryID INT, MakeID INT, FOREIGN KEY (MakeID) REFERENCES Make(MakeID), FOREIGN KEY (CategoryID) REFERENCES Category(CategoryID));
